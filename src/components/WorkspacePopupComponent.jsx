import { addWorkspace } from "@/app/service/workspace.service";
import Image from "next/image";
import React from "react";

export default function WorkspacePopupComponent() {
  async function addWorkspaces(dataInput) {
    "use server";
    const getworkspace = {
      workspaceName: dataInput.get("workspaceName"),
    };
    const addspace = await addWorkspace(getworkspace);
  }
  return (
    <div>
